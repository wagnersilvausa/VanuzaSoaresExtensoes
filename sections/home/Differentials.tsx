...
const items = [
  ...
  },
  {
    ...
    desc: 'Extensões integradas de forma impecável, sem marcas, sem reclamações. Fios que parecem seus.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
    ...
    desc: 'Cada cliente é única. Ouvimos, avaliamos e recomendamos a técnica perfeita para seu momento.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
    ...
    desc: 'Trabalhamos apenas com insumos de alta qualidade que garantem durabilidade e segurança capilar.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
    ...
    desc: 'Mais de 11 mil seguidoras e 5 mil clientes satisfeitas validam nossa entrega.',
  },
  {
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-7 h-7">
    ...
    desc: 'Compartilhamos o conhecimento com quem quer entrar no universo do mega hair profissional.',
  },
];
