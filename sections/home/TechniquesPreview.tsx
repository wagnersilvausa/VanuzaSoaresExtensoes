...
const techniques = [
  {
    num: '01',
    name: 'Microlink',
    desc: 'Aplicação estratégica com acabamento discreto. Ideal para quem busca leveza, praticidade e um visual sofisticado.',
    detail: 'Duração 2 a 3 meses',
    icon: (
  ...
  },
  {
    num: '02',
    name: 'Fita Adesiva',
    desc: 'Técnica versátil que oferece rapidez na aplicação, conforto no uso e excelente adaptação ao visual natural.',
    detail: 'Duração 1 a 2 meses',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-8 h-8">
  ...
  },
  {
    ...
    desc: 'Método pensado para proporcionar firmeza, segurança e um resultado bonito com boa distribuição dos fios.',
    detail: 'Duração 2 a 3 meses',
    icon: (
      <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} className="w-8 h-8">
  ...
  },
  {
    num: '04',
    name: 'Manutenção',
    desc: 'Cuidado essencial para preservar o bom resultado, a durabilidade da técnica e a saúde dos fios naturais.',
